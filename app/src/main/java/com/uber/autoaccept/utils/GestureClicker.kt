...
object GestureClicker {
    ...
    /** dispatchGesture 콜백 대기 타임아웃 */
    private const val DEFAULT_GESTURE_TIMEOUT_MS = 3000L
    ...
    suspend fun click(
        ...
        return try {
            withTimeout(DEFAULT_GESTURE_TIMEOUT_MS) {
            ...
            Log.w(TAG, "❌ Gesture click timeout ($finalX, $finalY)")
            false
        }
    }
